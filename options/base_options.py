...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--train_frames_per_scene', type=int, default=25)
        self.parser.add_argument('--valid_frames_per_scene', type=int, default=25)
        self.parser.add_argument('--test_frames_per_scene', type=int, default=10)
